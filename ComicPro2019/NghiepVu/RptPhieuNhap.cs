...
namespace ComicPro2019.NghiepVu
{
    ...
    public partial class RptPhieuNhap
    {
        public RptPhieuNhap()
        {
            InitializeComponent();
        ...
        public void BindData()
        {
            ...
            col_tap.DataBindings.Add("Text", DataSource, "tap"); col_soluong.DataBindings.Add("Text", DataSource, "slnhap", "{0:#,##0}");
            col_dongia.DataBindings.Add("Text", DataSource, "dongia", "{0:#,##0}");
            col_thanhtien.DataBindings.Add("Text", DataSource, "thanhtien", "{0:#,##0}");
            stt.Summary = new XRSummary(SummaryRunning.Report, SummaryFunc.RecordNumber, "{0:#,##0}");
            col_tongsoluong.DataBindings.Add("Text", DataSource, "slnhap");
